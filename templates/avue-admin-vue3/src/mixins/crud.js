export default (app, option = {}) => {
  const optionObj = import.meta.glob('../option/**/**')[
    `../option/${option.name}.js`
  ]
  const apiObj = import.meta.glob('../api/**/**')[`../api/${option.name}.js`]
  const mixins = {
    data() {
      return {
        data: [],
